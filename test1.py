...
def main():
    ...
    for group_idx, group in enumerate(measurement_groups):
        ...
        for i, (x, y, z, mt) in enumerate(group):
            ...
            if not kalman_filter.first_rep_flag or (kalman_filter.first_rep_flag and not kalman_filter.second_rep_flag):
    ...
    plt.scatter(t, r, label='filtered range (code)', color='green', marker='*')
    ...
    plt.figure(figsize=(12, 6))
    plt.subplot(facecolor="white")
    plt.scatter(t, az, label='filtered azimuth (code)', color='green', marker='*')
    ...
    plt.figure(figsize=(12, 6))
    plt.subplot(facecolor="white")
    plt.scatter(t, el, label='filtered elevation (code)', color='green', marker='*')
